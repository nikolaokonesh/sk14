        ...
        div(
          ...
          div(class: "hero-content flex-col lg:flex-row-reverse") do
            div(class: "text-center lg:text-left") do
              h1(class: "text-3xl md:text-4xl font-bold") { page_title }
              p(class: "py-6") do
            ...
            div(class: "card bg-base-300 w-full max-w-sm shrink-0 shadow-2xl") do
              div(class: "card-body") do
                fieldset(class: "fieldset") do
                  form_with(model: @user, url: auth_name_path(@user), method: :put) do |f|
                    render_form_field(f, :name, "Напишите свое имя") do
                      f.text_field :name, maxlength: 50, placeholder: "Иванов Иван",
                        class:  [ "input input-lg md:input-xl", { "input-error": @user.errors[:name].any? } ]
                    end
